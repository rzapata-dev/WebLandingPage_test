  ...
  return (
    <footer className="Footer__container">
      <div className="Footer__section Footer__mapa">
        ...
        <ul>
          <li><a className="nav__link" to="/" >Inicio</a></li>
          <li><a className="nav__link" to="/whoami">Quiénes Somos</a></li>
          <li><a className="nav__link" to="/questions">Preguntas</a></li>
          <li><a className="nav__link" to="/contact">Contactenos</a></li>
          <li><a className="nav__link" to="/exchange-rate">Divisas</a></li>
        </ul>
      </div>
